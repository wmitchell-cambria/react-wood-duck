...
describe('RaceForm', () => {
  ...
  it('it disables the race fields, except "Unknown" if it is checked', () => {
    ...
    expect(component.find('RaceField[race="White"]').props().disabled).toEqual(
      true
    );
    expect(
      component.find('RaceField[race="Black or African American"]').props()
        .disabled
    ).toEqual(true);
    expect(component.find('RaceField[race="Asian"]').props().disabled).toEqual(
      true
    );
    expect(
      component
    ...
    expect(
      component.find('RaceField[race="Unknown"]').props().disabled
    ).toEqual(false);
    expect(
      component.find('RaceField[race="Abandoned"]').props().disabled
    ).toEqual(true);
    expect(
