import RaceField from '../../Race/RaceField';
...
describe('RaceField', () => {
  ...
  it('renders the checkbox', () => {
    ...
    const checkbox = component.find(
      'CheckboxField[id="participant-123-race-Black_or_African"]'
    );
  ...
  it('fires on race change when race checkbox is changed', () => {
    ...
    component
      .find('CheckboxField[id="participant-123-race-Black_or_African"]')
  ...
  it('renders the select field for race detail when race is checked', () => {
    ...
    const select = component.find(
      'SelectField[id="participant-123-Black_or_African-race-detail"]'
    );
