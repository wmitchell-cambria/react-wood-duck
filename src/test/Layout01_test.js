...
describe('Layout01', function() {
    ...
    it("find if it contains GlobalHeader and PageHeader", function() {
        ...
        const globalHeaderComponent = TestUtils.scryRenderedComponentsWithType(layout, GlobalHeader);
        expect(globalHeaderComponent.length).toEqual(1);
        const pageHeader = TestUtils.scryRenderedComponentsWithType(layout, PageHeader);
