...
describe('InputField', () => {
  ...
  describe('basic functionality', () => {
    beforeEach(() => {
      component = shallow(
        <InputField {...props} onChange={onChange} onBlur={onBlur} />
      );
    ...
    it('renders the input placeholder', () => {
      ...
      expect(inputElement.props().placeholder).toEqual(
  ...
  describe('when it is required', () => {
    beforeEach(() => {
      component = shallow(
        <InputField {...props} onChange={onChange} onBlur={onBlur} required />
      );
    });
  ...
  describe('when it is disabled', () => {
    beforeEach(() => {
      component = shallow(
        <InputField {...props} onChange={onChange} onBlur={onBlur} disabled />
      );
    });
