  ...
  describe('when there are errors', () => {
    ...
    describe('when ariaDescribedBy is passed', () => {
      ...
      it('adds an aria-describedby prop', () => {
        expect(
          component.find(
            ".input-error-message[aria-describedby='myInputFieldId']"
          ).length
        ).toEqual(2)
      })
      ...
      it('adds a role prop', () => {
        expect(
          component.find(".input-error-message[role='alert']").length
        ).toEqual(2)
      })
      ...
      it('displays error messages', () => {
        ...
        expect(
          component
            ...
            .first()
            .text()
        ).toEqual('You have failed this city')
        expect(
          component
            .find('.input-error-message')
            .last()
            .text()
        ).toEqual('Stick to the plan!')
      })
    })
    ...
    describe('when ariaDescribedBy is not passed', () => {
      ...
      it('does not add an aria-describedby prop', () => {
        expect(component.first('.input-error-message').html()).not.toContain(
          'aria-describedby'
        )
      })
