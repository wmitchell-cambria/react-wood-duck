                ...
                {latinoOrigin === 'Yes' && (
                  <SelectField
                    ...
                    onChange={({ target: { value } }) =>
                      onChange('ethnicity_detail', [value])
                    }
                  >
                    <option key="" value="" />
                    {ethnicityDetailOptions.map(({ value, label }) => (
          ...
          <ul className="unstyled-list">
            ...
            <li>
              <CheckboxField
                ...
                disabled={
                  disableFields && latinoOrigin !== 'Declined to answer'
                }
                onChange={({ target: { checked } }) => {
                  if (checked) {
...
EthnicityForm.propTypes = {
  ...
  ethnicityDetailOptions: PropTypes.arrayOf(
    PropTypes.shape({
