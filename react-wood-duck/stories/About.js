      ...
      <div className="row">
        <div className="col-md-12">
          <div className="styleguide-inner">
            <h1 className="styleguide">CWDS Component Library</h1>

            <p className="lead">Version 0.31</p>

            <p className="lead">
              This component library is for all the digital services to
              contribue to and use for CWDS. Current library is React components
              and CSS based. This is a cross team collaborative effort between
              designer and developers on Intake, CALS, and Case Managment. It is
              open source and the repository can be found at:{' '}
            ...
            <ul>
              <li>
                <a href="https://github.com/ca-cwds/research-design/wiki">
                  Component library vision and goals
                </a>
              </li>
              <li>
