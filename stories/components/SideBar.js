    ...
    <NavLinks>
      ...
      <NavLink text='People & Roles' href='#pplroles' >
          <NavLinks nested={true}>
            <NavLink text='Tommy Cambell' href='#tommy' preIcon='fa fa-user' postIcon='fa fa-exclamation-triangle c-red' indentationLevel={1} />
            <NavLink text='Aubrey Cambell' href='#aubrey' preIcon='fa fa-user' indentationLevel={1} />
            <NavLink text='Chris Cambell' href='#chris'preIcon='fa fa-user' indentationLevel={1} />
          </NavLinks>
      </NavLink>
      ...
      <NavLink text='Decision' href='#decision' postIcon='fa fa-exclamation-triangle c-red' />
    </NavLinks>
;
            ...
            <code style=${codeStyle}>
               &lt;SideNav&gt;
                    &lt;NavLinks&gt;
                        &lt;NavLink text="Screener Summary" href="#screenerSummary" /&gt;
                        &lt;NavLink", text="Allegations & Disposition" href="#allegations" /&gt;
                        &lt;avLink", text="History of Involvement" href="#history" /&gt;
                    &lt;/NavLinks&gt;
               &lt;/SideNav&gt;
           </code>
